hand {
    left {
        ...
        wrist(x -0.3…0.3, y 0.8…1.2, z -0.5…0.01, time, phase, joint)
        forearm(x -0.3…0.3, y 0.8…1.2, z -0.5…0.01, time, phase, joint)
    }
    right {
        thumb {
            knuc(x -0.3…0.3, y 0.8…1.2, z -0.5…0.01, time, phase, joint)
...
touch(x -0.3…0.3, y 0.8…1.2, z -0.5…0.01, time, phase, joint, <- (hand.left.middle.tip, hand.right.middle.tip))
