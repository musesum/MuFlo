...
public class MuArchive {
    ...
    public static func readArchive(_ archiveName: String) -> MuArchive? {
    ...
    public func add(_ filename: String, data: Data) {
    ...
    public func get(_ filename: String,
                    _ bufSize: Int,
    ...
    public func copy(_ at: String,  to: String) {
